...
juce::AudioProcessorValueTreeState::ParameterLayout EuclideanSequencerAudioProcessor::createParameters() {
    ...
    paramsVector.push_back(make_unique<juce::AudioParameterChoice>("CHANNEL_COMBOBOX4", "Channel Combobox",
        juce::StringArray("Channel 1", "Channel 2", "Channel 3", "Channel 4", "Channel 5", "Channel 6", "Channel 7", "Channel 8", "Channel 9",
            "Channel 10", "Channel 11", "Channel 12", "Channel 13", "Channel 14", "Channel 15", "Channel 16"), 0));
...
void EuclideanSequencerAudioProcessor::setNewChannel(int value) {
    midiChannel = value;
}
