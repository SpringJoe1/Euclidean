...
private:
    ...
    void setSliderParams(juce::Slider& slider, int id);
    ...
    // this is the class that implements the default JUCE look-and-feel to customize
    juce::LookAndFeel_V4 otherLookAndFeel[NUM_TOTAL_ETAPAS];
    ...
    unique_ptr <ComboBoxAttachment> channelComboBoxAttachment;
